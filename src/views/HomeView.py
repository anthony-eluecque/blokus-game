...
class HomeView(View):
    ...
    def _UI(self : Self):
        ...
        self.rulesButton = Bouton(self.window,self,240,380,width=196,heigth=49,file="./media/assets/button_rules.png",son="button",command=self.homeController.btnRules)
        
        self.playButton = Bouton(self.window,self,260,300,width=158,heigth=49,file="./media/assets/button_play.png",son="button",command=self.homeController.btnPlay)
        
        self.statsButton = Bouton(self.window,self,230,440,width=221,heigth=49,file="./media/assets/button_stats.png",son="button",command=self.homeController.btnStats)
        self.leaveButton = Bouton(self.window,self,260,500,width=158,heigth=49,file="./media/assets/button_leave.png",son="button",command=self.window.destroy)
